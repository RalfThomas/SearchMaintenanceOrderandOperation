...
sap.ui.define(
    ...
    function(Control, jQuery, JSONModel, MessageToast, ResponsivePopover, List, DisplayListItem, Device) {
        ...
        return Control.extend('zi2d.eam.orderandoperation.monitors1.ext.controls.ExtScanner', {
            metadata: {
                manifest: 'json',
                properties: {
            ...
            getSettingsPopover: function() {
                if (!this.oSettingsPopover) {
                    this.oSettingsPopover = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.orderandoperation.monitors1.ext.controls.fragments.settingsPopover', this);
            ...
            _getScanDialog: function() {
                if (!this._oTD) {
                    this._oTD = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.orderandoperation.monitors1.ext.controls.fragments.scanDialog', this);
            ...
            _getInputDialog: function() {
                if (!this._oID) {
                    this._oID = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.orderandoperation.monitors1.ext.controls.fragments.inputDialog', this);
            ...
            _getDialogHeader: function() {
                if (!this._oHeader) {
                    this._oHeader = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.orderandoperation.monitors1.ext.controls.fragments.toolbar', this);
